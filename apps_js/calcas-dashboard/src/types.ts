...
export const RegistrationFormSchema = z.object({
    ...
    siblings_names: z.string().optional(),

    // Documents
    photo: z.instanceof(File).optional(),
    document: z.instanceof(File).optional(),
    document_2: z.instanceof(File).optional(),
    document_3: z.instanceof(File).optional(),
    document_4: z.instanceof(File).optional(),
    document_5: z.instanceof(File).optional(),
    document_6: z.instanceof(File).optional(),
    document_7: z.instanceof(File).optional(),
    document_8: z.instanceof(File).optional(),
    document_9: z.instanceof(File).optional(),
    document_10: z.instanceof(File).optional(),
...
export interface RegistrationDetail {
    ...
    document_4_url: string | null
    document_5_url: string | null
    document_6_url: string | null
    document_7_url: string | null
    document_8_url: string | null
    document_9_url: string | null
    document_10_url: string | null
