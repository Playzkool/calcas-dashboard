                            ...
                            <Box sx={{ flexShrink: 0, textAlign: "center" }}>
                                {data.photo_url ? (
                                    <Box
                                        component="img"
                                        src={data.photo_url}
                                        alt={`Photo de ${data.firstname} ${data.lastname}`}
                                        sx={{
                                            width: 96,
                                            height: 120,
                                            objectFit: "cover",
                ...
                <Card variant="outlined">
                    <CardContent>
                        ...
                        <Grid container spacing={2}>
                            ...
                            {data.siblings_names && (
                                <Grid size={{ xs: 12 }}>
                                    <InfoField label="Prénoms des frères et sœurs" value={data.siblings_names} />
                                </Grid>
                            )}
                        </Grid>
                    </CardContent>
                ...
                <Card variant="outlined">
                    <CardContent>
                        ...
                        <Stack spacing={1}>
                            ...
                            {([
                                "document_2_url", "document_3_url", "document_4_url",
                                "document_5_url", "document_6_url", "document_7_url",
                                "document_8_url", "document_9_url", "document_10_url",
                            ] as const).map((key, i) =>
                                data[key] ? (
                                    <DocLink key={key} label={`Autre document ${i + 2}`} url={data[key]} />
                                ) : null
                            )}
                            ...
                            <DocLink label="Photo d'identité" url={data.photo_url} />
                        </Stack>
                    </CardContent>
                </Card>
